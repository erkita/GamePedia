  ...
  <div class="container-fluid">
	...
	<form action="userupdate" method="post">
		<p>
			...
			<input class="border border-dark" id="username" name="username" value="${fn:escapeXml(param.username)}" placeholder="eg.Unicorns24">
		</p>
		<p>
			<label for="email" class="h3">New Email</label>
			<input class="border border-dark" id="email" name="email" value="">
		</p>
		<p>
			<label for="firstname" class="h3">New FirstName</label>
			<input class="border border-dark" id="firstname" name="firstname" value="">
		</p>
		<p>
			<label for="password" class="h3">New Password</label>
			<input class="border border-dark" id="password" name="password" value="">
		</p>
		<p>
