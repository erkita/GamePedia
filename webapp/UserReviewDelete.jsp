...
<nav class="navbar navbar-dark bg-dark fixed-top">
  <div class="container-fluid">
	...
	<div class="container">
	<div class="row">
	<h1>Delete a User Review</h1>
	<form action="userreviewdelete" method="post">
		<p>
			<div <c:if test="${messages.disableSubmit}">style="display:none"</c:if>>
				<label for="userreviewid">User review ID</label>
				<input class="form-control border border-dark" id="userreviewid" name="userreviewid" value="${fn:escapeXml(param.userreviewid)}">
			</div>
		</p>
		<p>
