	...
	<form action="gamedelete" method="post">
		<p>
			<div <c:if test="${messages.disableSubmit}">style="display:none"</c:if>>
				...
				<input placeholder="Type the game name that you want to delete" class="form-control border border-dark" id="gamename" name="gamename" value="${fn:escapeXml(param.gamename)}">
			</div>
		</p>
		<p>
