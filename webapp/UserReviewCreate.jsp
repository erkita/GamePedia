...
<nav class="navbar navbar-dark bg-dark fixed-top">
  <div class="container-fluid">
	...
	<div class="container">
	<div class="row">
	<h1>Create a User Review</h1>
	<form action="userreviewcreate" method="post">
		
		<p>
			<label for="gameid">Game Id</label>
			<input class="form-control border border-dark" id="gameid" name="gameid" value="">
		</p>
		<p>
			<label for="gamename">Game Name</label>
			<input class="form-control border border-dark" id="gamename" name="gamename" value="${game.getGameName()}">
		</p>
		<p>
			<label for="username">Username</label>
			<input class="form-control border border-dark" id="username" name="username" value="">
		</p>
		<p>
			<label for="review">Is your review positive? (Type "true" or "false")</label>
			<input class="form-control border border-dark" id="review" name="review" value="">
		</p>
